    ...
    public function checkdbAction()
    {
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-event-task',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-event-task/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-event-task/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-event-task/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key' => 'oneplace-event-task',
                'type' => 'plugin',
                'version' => \OnePlace\Event\Task\Module::VERSION,
                'label' => 'onePlace Event Task',
                'vendor' => 'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Event Task DB Update successful');
